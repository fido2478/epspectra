...
void StrlPerfGraph::outputGraph(double seconds) {
  ...
  int i;
  FILE *fdd=fopen("/net/home/hkim/project/data_flow_model/perf_data/tot_cyc_mod_strl_dfm.gnu","w");//permod
  FILE *fgl=fopen("/net/home/hkim/project/data_flow_model/perf_data/run_comp_sch_strl_dfm.gnu","w");//gl
...
void StrlPerfGraph::gnu_sample_modules(double seconds){
  int i;
  FILE *fdd=fopen("/net/home/hkim/project/data_flow_model/perf_data/tot_smpl_mod_strl_dfm.gnu","w");//define directory
