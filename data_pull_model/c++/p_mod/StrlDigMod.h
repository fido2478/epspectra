...
#ifdef CHK_ALPH
    cout <<"time: "<<time<<", tmp_a: "<<tmp_a<<", fr_c: "<<fr_c<<", tmp_p: "<<tmp_p<<", Tb: "<<Tb<<", alpha: "<<alpha<<endl;
    cout <<"2*pi*fr_c*time+tmp_p : "<<2*pi*fr_c*time+tmp_p<<endl;
    cout <<"pi*time/Tb : "<<pi*time/Tb<<endl;
    cout <<"alpha*pi*time/Tb : "<<alpha*pi*time/Tb<<endl;
    cout <<"(1-((2*alpha*time/Tb)*(2*alpha*time/Tb))"<<(1-((2*alpha*time/Tb)*(2*alpha*time/Tb)))<<endl;
    cout <<"cos(2*pi*fr_c*time+tmp_p) : "<<cos(2*pi*fr_c*time+tmp_p)<<endl;
    cout <<"sin(pi*time/Tb)/(pi*time/Tb) : "<<sin(pi*time/Tb)/(pi*time/Tb)<<endl;
    cout <<"cos(alpha*pi*time/Tb)/(1-((2*alpha*time/Tb)*(2*alpha*time/Tb))) : "<<cos(alpha*pi*time/Tb)/(1-((2*alpha*time/Tb)*(2*alpha*time/Tb)))<<endl;
    cout <<"p_t["<<tmp_i<<"] : "<<p_t[tmp_i]<<" = "<<(double) (tmp_a
		* (cos(2*pi*fr_c*time+tmp_p))
		* (sin(pi*time/Tb)/(pi*time/Tb))
		* (cos(alpha*pi*time/Tb)/(1-((2*alpha*time/Tb)*(2*alpha*time/Tb)))) )<<endl;
#endif
#endif
